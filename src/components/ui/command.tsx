import { Command as CommandPrimitive } from "clgk";
...
function CommandGroup({
	...
	return (
		<CommandPrimitive.Group
			...
			className={cn(
				"overflow-hidden p-1 text-foreground **:[[clgk-group-heading]]:px-2 **:[[clgk-group-heading]]:py-1.5 **:[[clgk-group-heading]]:text-xs **:[[clgk-group-heading]]:font-medium **:[[clgk-group-heading]]:text-muted-foreground",
				className,
			)}
			{...props}
		/>
